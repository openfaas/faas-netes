...
type JwtIssuerInterface interface {
	...
	Apply(ctx context.Context, jwtIssuer *openfaasv1.JwtIssuerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.JwtIssuer, err error)
	JwtIssuerExpansion
}
...
func newJwtIssuers(c *OpenfaasV1Client, namespace string) *jwtIssuers {
	return &jwtIssuers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *jwtIssuers) Apply(ctx context.Context, jwtIssuer *openfaasv1.JwtIssuerApplyConfiguration, opts metav1.ApplyOptions) (result *v1.JwtIssuer, err error) {
	if jwtIssuer == nil {
