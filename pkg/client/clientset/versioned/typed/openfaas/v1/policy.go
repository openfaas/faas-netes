...
type PolicyInterface interface {
	...
	Apply(ctx context.Context, policy *openfaasv1.PolicyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Policy, err error)
	PolicyExpansion
}
...
func newPolicies(c *OpenfaasV1Client, namespace string) *policies {
	return &policies{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *policies) Apply(ctx context.Context, policy *openfaasv1.PolicyApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Policy, err error) {
	if policy == nil {
