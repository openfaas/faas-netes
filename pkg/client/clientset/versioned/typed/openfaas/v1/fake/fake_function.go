...
func (c *FakeFunctions) UpdateStatus(function *openfaasv1.Function) (*openfaasv1.Function, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(functionsResource, "status", c.ns, function), &openfaasv1.Function{})
