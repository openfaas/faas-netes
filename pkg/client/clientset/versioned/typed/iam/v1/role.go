...
func newRoles(c *IamV1Client, namespace string) *roles {
	return &roles{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *roles) Apply(ctx context.Context, role *iamv1.RoleApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Role, err error) {
	if role == nil {
